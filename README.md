...
Anteriormente, utilizei o pacote *oxmnx* - desenvolvido e mantido por Geoff Boeing, professor de Planejamento Urbano e Análise Espacial da USC - University of Southern California - para análise de redes viárias urbanas. Agora, atualizei o código em Python escrito pelo cientista de dados [*Jack McKew*](https://jackmckew.dev/street-suffix-analysis-colouring-with-python), para visualizar as vias públicas de Juiz de Fora/MG, classificadas por tipo de logradouro.
...
* **Estrada**: conecta a zona rural, distritos e cidades vizinhas ao perímetro urbano.
